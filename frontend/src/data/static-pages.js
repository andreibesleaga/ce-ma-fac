export default [
  ...
  },
  {
    ...
    form: [
      ...
      },
      {
        questionId: 15,
        questionText:
          "Ai călătorit în/prin zone în care au existat cazuri de noul coronavirus?",
        type: "SINGLE_CHOICE",
        options: [
          {
            label: "Da",
    ...
    content: [
      {
        ...
        <h3>Stresul în timpul unei epidemii infecțioase poate include: </h3>
         <ul>
          ...
          <li>Schimbări în rutina programului de somn și de alimentație</li>
          <li>Dificultatea de a dormi și de a te concentra</li>
          <li>Agravarea problemelor de sănătate cronice</li>
          <li>Abuzul de alcool, tutun sau alte tipuri de substanțe cu risc de dependență</li>
        </ul>
      ...
      },
      {
        ...
        <ul>
          ...
          <li>Întoarcerea la comportamente pe care le depășiseră (de exemplu, accidente în rutina legată de mersul la toaletă sau urinat în pat)</li>
          <li>Grijă excesivă sau tristețe</li>
          <li>Alimentație nesănătoasă sau deviații ale rutinei de somn</li>
          <li>Iritabilitate sau comportament rebel în rândul adolescenților</li>
          <li>Performanțe școlare slabe sau evitarea cursurilor</li>
          <li>Dificultate în a menține atenția sau concentrarea</li>
          <li>Evitarea activităților care le făceau plăcere în trecut</li>
      ...
      },
      {
        ...
        <ul>
          ...
          <li>Teamă și îngrijorare legată de propria sănătate și de sănătatea celor dragi</li>
          <li>Stresul cauzat de experiența auto-monitorizării sau a monitorizării celorlalți, pentru depistarea semnelor sau simptomelor specifice COVID-19</li>
      ...
      },
      {
        ...
        <ul>
          ...
          <li>Violență fizică</li>
        </ul>
        <p>Stigmatizarea afectează sănătatea emoțională sau mintală a grupurilor în cauză și a comunităților în care trăiesc. Oprirea stigmatului este importantă pentru rezistența comunităților și a membrilor săi. </p>
        <p>Fiecare poate ajuta la stoparea stigmatizării din jurul COVID-19 cunoscând faptele și transmițându-le celorlalți membrii ai comunității. </p>
        <p>Specialiștii în comunicare și oficialii din sistemul de sănătate publică pot contracara stigmatizarea prin modul în care răspund la COVID-19.</p>
        <ul>
          <li>Păstrarea datelor de natură personală și a confidențialității celor care caută ajutor medical și al celor care ar putea face parte dintr-o investigație referitoare la contactele unui caz.</li>
          <li>Comunicarea rapidă a riscului sau a lipsei de risc asociat cu anumite produse, oameni sau locuri.</li>
          <li>Acțiuni de conștientizare publică despre COVID-19, fără a crește temerile din rândul populației.</li>
          <li>Transmiterea de informații corecte despre evoluția virusului.</li>
          <li>Luarea de atitudine împotriva comportamentelor negative, incluzând afirmațiile negative din social media despre anumite grupuri de oameni. </li>
          <li>Să fie prudenți în transmiterea anumitor imagini. Să se asigure că nu răspândesc stereotipuri. </li>
          <li>Relaționarea cu grupuri stigmatizate, prin interacțiuni personale și prin intermediul canalelor media, inclusiv cele de știri și de social media.</li>
    ...
    content: [
      {
        ...
        <ul>
          <li>Recunoaște faptul că STS poate afecta pe oricine care ajută alte persoane într-un eveniment traumatic.</li>
          <li>Învață care sunt simptomele, inclusiv cele fizice (oboseală, boală) și psihice (frică, sevraj, vinovăție) pentru a le putea recunoaște mai ușor.</li>
          <li>Acordă timp, atât ție cât și familiei tale pentru a vă recupera după ce ai făcut parte din forțele de răspuns la pandemie.</li>
          <li>Creează-ți un program cu activități de îngrijire personală de care te bucuri, precum să petreci timp cu prietenii și familia, să faci exerciții fizice sau să citești o carte.</li>
         ...
         <ul>
          ...
          <li>Sentimente de frustrare, care apar cu ușurință</li>
          <li>Reacții de apărare - dai vina pe alții, iritabilitate</li>
          <li>Lipsa emoțiilor, indiferență</li>
          <li>Detașament - Izolare sau deconectare de ceilalți</li>
          <li>Neglijarea igienei personale</li>
          <li>Senzație constantă de oboseală, epuizare (secare de energie) sau de copleșire</li>
          <li>Poți să ai senzația:
            <ul>
              <li>De eșec</li>
              <li>Că nimic din ceea ce faci nu mai ajută, nu mai are sens</li>
              <li>Că nu îți faci treaba bine</li>
              <li>Că ai nevoie de alcool/alte substanțe pentru a face față</li>
            </ul>
          </li>
         </ul>
         ...
         <ul>
          ...
          <li>Semne fizice de stres (de exemplu senzația că inima îți bate cu putere)</li>
          <li>Coșmaruri sau ganduri recurente legate de situații traumatice </li>
         ...
         <ul>
          <li><strong>Cunoașteți-vă.</strong> Vorbiți despre trecutul fiecăruia, interese, hobby-uri și familie. Identificați-vă reciproc punctele forte și slăbiciunile. </li>
          <li><strong>Fiți atenți unul la celălalt.</strong> Dacă se poate, încercați să lucrați în aceeeșii locație. </li>
          <li><strong>Setați ore când veți intra în contact</strong> unul cu celălalt. Ascultați cu atenție și împărtășiți experiențe și sentimente. Încercați să acceptați situațiile dificile și marcați realizările/ micile succese, chiar și pe cele mai mici. </li>
          <li><strong>Oferiți-vă ajutorul pentru nevoile de bază</strong> Vorbiți despre trecutul fiecăruia, interese, hobby-uri și familie. Identificați-vă reciproc punctele forte și slăbiciunile. </li>
         ...
         <ul>
          ...
          <li>Încearcă să ții un jurnal.</li>
          <li>Vorbește cu familia, prietenii, șefii și colegii despre sentimentele și trăirile tale.</li>
          <li>Exersează tehnici de respirație și relaxare.</li>
          <li>Menține o dietă sănătoasă și asigură-te că ai un program adecvat de somn și exerciții fizice.</li>
         ...
         <ul>
          ...
          <li>Nevoile supraviețuitorilor nu sunt mai importante decât bunăstarea sau propriile tale nevoi.</li>
          <li>Să lucrezi tot timpul nu înseamnă că vei avea cea mai bună contribuție.</li>
  ...
  },
  {
    ...
    accordion: [
      {
        title: `Ce este noul coronavirus?`,
        content: `
      ...
      },
      {
        ...
        content: `
            <p>Virusul care cauzează COVID-19 se răspândește de la om la om. Cineva care este bolnav cu COVID-19 poate răspândi boala către alții. De aceea se recomandă carantinarea pacienților până sunt din nou sănătoși și nu mai prezintă risc de infecție pentru alții.</p>
            <p>Se crede că virusul se răspândește mai ales de la persoană la persoană în mod direct:</p>
            <ul>
      ...
      },
      {
        ...
        content: `
            <p>Cât de multă vreme o persoană e bolnavă în mod activ variază de la om la om și la fel poate varia decizia de a elibera pe cineva din spital, carantină sau izolare. Eliberarea se face de la caz la caz în funcție de decizia personalului medical și al specialiștilor în prevenția răspândirii bolilor infecțioase. Decizia se ia pe baza simptomatologiei și testelor de laborator.</p>
            <p>Directivele Centrului de Control și Prevenția al Bolilor (CDC) din SUA subliniază trei criterii pentru eliberarea din carantină:</p>
            <ul>
                <li>Pacientul nu are febră (fără a fi folosit medicamente ce reduc febra)</li>
                <li>Pacientul nu are tuse sau alte simptome fizice</li>
...
Cea mai sigură metodă de evitare a infecției este să evitați expunerea la virus prin limitarea contactului cu alte persoane sau autoizolare (așa-numitele metode de distanțare socială).
      ...
      },
      {
        ...
        content: `
            <p>Dacă sunteți într-o grupă de risc:</p>
            <ul>
                <li>Asigurați-vă că aveți un stoc din medicamentele pe care le luați în mod curent în caz că trebuie să stați acasă o perioadă mai îndelungată.</li>
                <li>Stați acasă.</li>
      ...
      },
      {
        ...
        content: `
            <p>Cele mai răspândite simptome pentru infecția cu noul coronavirus sunt:</p>
             <ul>
                <li>Febră</li>
                <li>Tuse seacă</li>
                <li>Dificultăți de respirație</li>
            </ul>
            <p>Acestea pot apărea între 2 și 14 zile după expunere. De obicei apar în primele 7 zile.</p>
            <p>Marea majoritate (80%) a persoanelor care se îmbolnăvesc prezintă simptome ușoare sau foarte ușoare, echivalentul unei răceli sau unei pneumonii ușoare. Un număr de aproximativ 15% prezintă complicații și au nevoie de spitalizare. Un număr de aproximativ 5% prezintă complicații grave necesitând tratament de urgență.</p>
            <p>Simptomele de urgență ale COVID-19 sunt:</p>
            <ul>
                <li>Dificultăți severe de respirație</li>
                <li>Durere sau presiune constantă în piept</li>
                <li>Confuzie</li>
      ...
      },
      {
        ...
        content: `
            <p>Conform Organizației Mondiale a Sănătății, următoarele comportamente nu sunt eficiente împotriva COVID-19 și pot fi dăunătoare:</p>
            <ul>
                <li>Fumatul</li>
